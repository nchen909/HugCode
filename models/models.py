...
from models.T5ForConditionalGeneration_Prefix import T5ForConditionalGeneration_Prefix
from models.T5ForConditionalGeneration_Prefix_2 import T5ForConditionalGeneration_Prefix_2
from models.PLBartForConditionalGeneration_Prefix import PLBartForConditionalGeneration_Prefix
from models.Seq2Seq import Seq2Seq, Seq2Seq4UniXcoder_completion, Seq2Seq4UniXcoder_generation, Seq2Seq4UniXcoder_e2d
from models.Classification_Model import Model4UniXcoder, CloneModel, DefectModel
from models.unified.prefixtuning import E2D_Model_Prefix
from models.unified.adaptertuning import E2D_Model_Adapter
from models.unified.bitfit import E2D_Model_Bitfit
# from models.prompt.modeling_t5 import T5ForConditionalGeneration
#import codecs
...
# from transformers.models.plbart.modeling_plbart import PLBartForConditionalGeneration
# MODEL_CLASSES = {'roberta': (AutoConfig, RobertaModel, AutoTokenizer),
#                  'codebert': (AutoConfig, RobertaModel, AutoTokenizer),
#                  'graphcodebert': (AutoConfig, RobertaForMaskedLM, AutoTokenizer),
#                  'unixcoder':(AutoConfig, RobertaModel, AutoTokenizer),
#                  't5': (AutoConfig, T5ForConditionalGeneration, AutoTokenizer),
#                  'codet5': (AutoConfig, T5ForConditionalGeneration, AutoTokenizer),
#                  'bart': (AutoConfig, BartForConditionalGeneration, AutoTokenizer),
#                  'plbart':(AutoConfig, PLBartForConditionalGeneration, AutoTokenizer)}

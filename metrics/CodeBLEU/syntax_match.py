...
from metrics.CodeBLEU.parser import DFG_python, DFG_java, DFG_ruby, DFG_go, DFG_php, DFG_javascript, DFG_csharp,DFG_c
...
parser_path = '/data/pretrain-attention/CodePrompt/metrics/CodeBLEU/parser'
dfg_function = {
    'python': DFG_python,
    'java': DFG_java,
    'ruby': DFG_ruby,
